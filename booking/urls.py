...
urlpatterns = [
    ...
    path(
        "admin-movies/add/",
        views.admin_add_movie,
        name="admin_add_movie"
    ),

    path(
        "admin-movies/delete/<int:movie_id>/",
        views.admin_delete_movie,
        name="admin_delete_movie"
    ),
    ...
    path(
        "food-cart/add/<int:food_id>/",
        views.add_food_to_cart,
        name="add_food_to_cart"
    ),

    path(
        "food-cart/remove/<int:food_id>/",
        views.remove_food_from_cart,
        name="remove_food_from_cart"
    ),

    path(
        "food-cart/update/<int:food_id>/<str:action>/",
        views.update_food_qty,
